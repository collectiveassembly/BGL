var BGLTerms = [
{
	...
	content: {
		...
		project_meta: "BMW Guggenheim Lab, Berlin \n City Project: Dynamic Connections Bike Map \n Rachel Smith, Lab Team Member, Berlin \n Summer 2012-ongoing \n http://www.dynamicconnections.de/ \n Dynamic Connections Map is a project organized by BMW Guggenheim Lab Team member Rachel Smith with John Schimmel and Dave Dawson.",
		media: {
...
},
{
	...
	content: {
		...
		project_meta: "BMW Guggenheim Lab, Berlin Program: Marathon of Making June 15, 2012",
		media: {
...
},
{
	...
	content: {
		...
		project_desc: "Led by Greg Smithsimon, coauthor of The Beach Beneath the Streets, the Wall Street Occupation Tour brought visitors to Zuccotti Park, a ?bonus plaza? in Lower Manhattan. Bonus plazas are privately owned public spaces that are designed in response to setback regulations for skyscrapers.",
		project_meta: "BMW Guggenheim Lab, New York Program: Wall Street Occupation Tour October 12, 2011",
		media: {
...
{	number: "65",
	...
	content: {
		...
		project_meta: "BMW Guggenheim Lab, Mumbai Program: Being Brave: Privacy and the World Around You January 5, 2013, Batliboy Compound",
		media: {
...
},
{
	...
	content: {
		...
		project_meta: "BMW Guggenheim Lab, Mumbai City Project: Water Bench Neville Mars, Lab Team Member, Mumbai; MARS Architects 2013-ongoing waterbench.com",
		media: {
